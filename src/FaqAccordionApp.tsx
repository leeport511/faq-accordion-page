...
import { FaqQuestionAndAnswer } from './components/FaqQuestionAndAnswer';
import { AppTitle } from './components/AppTitle';

function FaqAccordionApp() {
	return (
		<main className='bg-purple100 w-screen h-screen flex flex-col items-center relative font-work-sans'>
			<div className='z-10'>
